...
exports.createListingUpload = (req, res) => {
    const { kind, title, description, userId, lifestyle, sociability, trainability, adaptability, activityLevel, temperament, allergies,
        experience, specialNeeds, background, behavior, medical, special, image, personalpreferences, likes, rating5,rating4,rating3,rating2,rating1,} = req.body;
