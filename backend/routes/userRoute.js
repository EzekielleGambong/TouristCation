...
console.log("Generated OTP:", otp);
      ...
      OTPStore.set(email, { otp, expiresAt: Date.now() + 300000 }); // Example 5-minute expiry
console.log("OTP stored for", email, ":", OTPStore.get(email)); // Debugging
  ...
  router.post('/verify-otp', async (req, res) => {
    try {
      ...
      console.log("Stored OTP:", OTPStore.get(email)); // Debugging
