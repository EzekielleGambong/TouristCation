...
function Accommodations() {
  ...
  const fetchTouristSpots = async () => {
    try {
      ...
      const response = await fetch(`https://www.touristcation.site/api/touristspots?${queryParams}`);
  ...
  const fetchFilteredAccommodations = async () => {
    try {
      ...
      const response = await fetch(`https://www.touristcation.site/api/accommodation?${queryParams}`);
      const data = await response.json();
