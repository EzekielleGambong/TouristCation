...
export function Knapsack(touristSpots, wholeBudget, budgetCap) {
  ...
  // Debugging: Check adjusted costs and selected spots
  console.log("Whole Budget:", wholeBudget);
  console.log("Budget Cap:", budgetCap);
  console.log("Adjusted Tourist Spots:", adjustedSpots);
  console.log("Selected Spots within Budget:", selectedSpots);

  // Return only the selected spots
  return selectedSpots.reverse(); // Reverse to maintain original order
}
...
//   const selectedSpots = [];
//   let remainingBudget = wholeBudget;
...
//   // Debugging: Show adjusted spots and selected results
//   console.log("Adjusted Tourist Spots:", adjustedSpots);
//   console.log("Selected Spots within Budget:", selectedSpots);
